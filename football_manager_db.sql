...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2026 at 04:23 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Advance_Day` ()   BEGIN
    ...
    SET current_game_date = DATE_ADD(current_game_date, INTERVAL 1 DAY)
    WHERE setting_id = 1;
    ...
    -- 4. Verificăm dacă e 1 ale lunii pentru contracte
    IF DAY((SELECT current_game_date FROM game_settings WHERE setting_id = 1)) = 1 THEN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Generate_Youth_Intake` (IN `p_team_id` INT)   BEGIN
    ...
    SET v_foot = IF(RAND() < 0.25, 'Left', 'Right');

    INSERT INTO player_core (team_id, country_code, name, age, is_youth, preferred_foot)
    VALUES (p_team_id, v_country, v_full_name, 16, TRUE, v_foot);
    ...
    ELSE
        INSERT INTO attributes_outfield (
            player_id,
            crossing, dribbling, finishing, first_touch, heading, long_shots,
            passing, marking, tackling, set_pieces, composure, determination,
            flair, workrate, teamwork, pace, stamina_max, strength
        ) VALUES (
            v_new_player_id,
            5+v_academy_lvl,             -- crossing
            5+v_academy_lvl,             -- dribbling
            5+v_academy_lvl,             -- finishing
            8+v_academy_lvl,             -- first_touch (mai important pentru tineri)
            5+v_academy_lvl,             -- heading
            3+v_academy_lvl,             -- long_shots (slabe la 16 ani)
            5+v_academy_lvl,             -- passing
            4+v_academy_lvl,             -- marking
            4+v_academy_lvl,             -- tackling
            3+v_academy_lvl,             -- set_pieces
            6+v_academy_lvl,             -- composure
            8+v_academy_lvl,             -- determination (tinerii au ambiție)
            FLOOR(3 + RAND() * v_academy_lvl), -- flair (random, talent natural)
            7+v_academy_lvl,             -- workrate
            6+v_academy_lvl,             -- teamwork
            10+v_academy_lvl,            -- pace (tinerii sunt rapizi)
            10+v_academy_lvl,            -- stamina_max
            5+v_academy_lvl             -- strength (slabă la 16 ani)
        );
    END IF;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Run_Weekly_Training` (IN `p_team_id` INT)   BEGIN
    DECLARE i INT DEFAULT 0;
    WHILE i < 7 DO
        CALL Run_Daily_Training();
        SET i = i + 1;
...
(1, 64, 59, 69, 61, 51, 61, 49, 56, 69, 66, 52, 49, 64, 60, 52, 64, 59),
(2, 78, 63, 72, 65, 60, 72, 50, 54, 55, 55, 61, 33, 58, 63, 40, 58, 63),
(16, 58, 67, 53, 60, 64, 57, 64, 68, 60, 63, 59, 46, 68, 55, 50, 70, 55),
(17, 57, 70, 70, 61, 71, 60, 59, 59, 53, 79, 63, 43, 64, 63, 45, 60, 61);
...
(1, 0, 195, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(2, 0, 94, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(3, 0, 168, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(4, 0, 119, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(5, 0, 129, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(6, 0, 90, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(7, 0, 102, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(8, 0, 163, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(9, 0, 189, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(10, 0, 136, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(11, 0, 155, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(12, 0, 164, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(13, 0, 159, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(14, 0, 102, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(15, 0, 195, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(16, 0, 176, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(17, 0, 92, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(18, 0, 93, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(19, 0, 108, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(20, 0, 181, 10, 10, 10, 10, 10, 10, 10, 10, 10),
(26, 79, 46, 77, 50, 70, 71, 83, 41, 52, 59, 58, 75, 38, 78, 61, 49, 66, 64),
(27, 65, 62, 73, 66, 44, 37, 83, 61, 47, 40, 50, 59, 38, 65, 60, 49, 72, 67),
(28, 54, 74, 50, 74, 71, 45, 68, 47, 48, 57, 59, 55, 61, 73, 77, 51, 59, 55),
(29, 40, 46, 69, 53, 69, 58, 61, 49, 42, 57, 78, 77, 59, 60, 76, 62, 69, 49),
(30, 47, 60, 79, 61, 45, 56, 54, 57, 68, 56, 64, 77, 74, 53, 69, 79, 65, 53);
...
(1, 'Martin Fischer', 2, 24389.00, 24, 12, 'Positive', 'Direct', 6, 6, 3),
(2, 'Klaus Weber', NULL, 16754.00, 0, 20, 'Cautious', 'Shorter', 6, 1, 5),
(3, 'Lucas Alves', NULL, 17037.00, 0, 21, 'Cautious', 'Direct', 7, 5, 4),
(4, 'Lucian Petrescu', NULL, 34121.00, 0, 3, 'Positive', 'Direct', 6, 5, 7),
(5, 'Matteo Colombo', NULL, 29064.00, 0, 4, 'Defensive', 'Mixed', 8, 9, 7),
(6, 'Francisco Martins', NULL, 5677.00, 0, 17, 'Cautious', 'Shorter', 2, 7, 9),
(7, 'William Davis', NULL, 12529.00, 0, 27, 'Cautious', 'Direct', 6, 8, 9),
(8, 'Radu Hagi', 1, 29872.00, 24, 12, 'Cautious', 'Mixed', 1, 3, 2),
(9, 'Riccardo Romano', NULL, 25540.00, 0, 22, 'Defensive', 'Shorter', 6, 3, 8),
(10, 'Manuel Hernandez', NULL, 26447.00, 0, 2, 'Attacking', 'Shorter', 9, 7, 10),
(11, 'Luiz Martins', NULL, 15153.00, 0, 2, 'Attacking', 'Direct', 5, 10, 3),
(12, 'Radu Hagi', NULL, 13106.00, 0, 6, 'Positive', 'Direct', 2, 10, 5),
(13, 'Hector Sanchez', NULL, 14186.00, 0, 1, 'Defensive', 'Shorter', 9, 3, 7),
(14, 'Martin Schulz', NULL, 24857.00, 0, 24, 'Defensive', 'Shorter', 5, 2, 5),
(15, 'Alessandro Gallo', NULL, 5918.00, 0, 9, 'Balanced', 'Shorter', 10, 1, 5),
(16, 'Gabriele Marino', NULL, 7582.00, 0, 16, 'Cautious', 'Shorter', 9, 7, 1),
(17, 'Francesco Greco', NULL, 29271.00, 0, 10, 'Defensive', 'Mixed', 4, 2, 7),
(18, 'Gheorghe Stan', NULL, 8809.00, 0, 26, 'Attacking', 'Direct', 1, 7, 8),
(19, 'Thierry Martin', NULL, 7817.00, 0, 14, 'Cautious', 'Shorter', 6, 7, 5),
(20, 'Jean Petit', NULL, 10487.00, 0, 26, 'Defensive', 'Direct', 8, 3, 10);
...
CREATE TABLE `player_core` (
  ...
  `preferred_foot` enum('Left','Right') DEFAULT 'Right',
...
INSERT INTO `player_core` (`player_id`, `team_id`, `academy_id`, `country_code`, `name`, `age`, `is_GK`, `preferred_foot`, `is_youth`, `salary_per_season`, `current_stamina`, `natural_fitness`, `morale`, `current_form`, `injury_days_left`, `suspension_matches_left`, `is_available`) VALUES
(1, 1, NULL, 'ITA', 'Marco Bianchi', 28, 1, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(2, 1, NULL, 'ROU', 'Andrei Ionescu', 21, 1, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(3, 1, NULL, 'ESP', 'Carlos Mendez', 26, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(4, 1, NULL, 'FRA', 'Antoine Dubois', 29, 0, 'Left', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(5, 1, NULL, 'ARG', 'Lucas Ferreira', 24, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(6, 1, NULL, 'GER', 'Thomas Bauer', 27, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(7, 1, NULL, 'ENG', 'James Wilson', 25, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(8, 1, NULL, 'ARG', 'Diego Herrera', 28, 0, 'Left', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(9, 1, NULL, 'ROU', 'Mihai Popescu', 23, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(10, 1, NULL, 'ESP', 'Rui Costa', 26, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(11, 1, NULL, 'FRA', 'Pierre Martin', 24, 0, 'Left', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(12, 1, NULL, 'ARG', 'Gabriel Santos', 25, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(13, 1, NULL, 'ESP', 'Roberto Garcia', 27, 0, 'Left', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(14, 1, NULL, 'ITA', 'Luca Romano', 22, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(15, 1, NULL, 'ARG', 'Matias Lopez', 29, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(16, 2, NULL, 'ENG', 'John Smith', 27, 1, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(17, 2, NULL, 'GER', 'Hans Schulz', 29, 1, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(18, 2, NULL, 'ESP', 'Luis Moreno', 25, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(19, 2, NULL, 'FRA', 'Pierre Dupont', 28, 0, 'Left', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(20, 2, NULL, 'ITA', 'Marco Rossi', 26, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(21, 2, NULL, 'ARG', 'Diego Castro', 30, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(22, 2, NULL, 'ENG', 'David Davis', 24, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(23, 2, NULL, 'GER', 'Matthias Weber', 27, 0, 'Left', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(24, 2, NULL, 'ESP', 'Antonio Ruiz', 25, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(25, 2, NULL, 'ITA', 'Luca Ferrari', 23, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(26, 2, NULL, 'ROU', 'Andrei Constantin', 26, 0, 'Left', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(27, 2, NULL, 'ENG', 'Richard Taylor', 28, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(28, 2, NULL, 'ARG', 'Marcelo Silva', 27, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(29, 2, NULL, 'GER', 'Klaus Bauer', 24, 0, 'Left', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL),
(30, 2, NULL, 'ESP', 'Carlos Vega', 29, 0, 'Right', 0, 10000, 100, 25, 25, 5.00, 0, 0, NULL);
...
(1, 1, 'Cosmopolitan FC', 5000000, 50, 10000, 5000, 1, 1, 0),
(2, 1, 'Academica Test', 3000000, 30, 8000, 5000, 1, 1, 1);
...
(1, 'Manager_Test', 'dof@test.com', '$2y$10$uhIzl7n3y1fofYYWWnZPfeipgilVetequJQ78xyv2zoIA.cvbb5S6', '2026-03-23 23:29:12');
